    ...
    <nav className="bg-gray-900 border-b border-gray-800 shadow-sm">
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400 hidden sm:block">Real-time Communication</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              to="/change-password"
              className="flex items-center gap-2 px-4 py-2 bg-gray-800 text-gray-300 rounded-lg hover:bg-gray-700 transition-colors font-medium text-sm"
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-red-900/30 text-red-400 rounded-lg hover:bg-red-900/50 transition-colors font-medium text-sm"
            >
      ...
      {showLogoutConfirm && (
        <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50 p-4">
          <div className="bg-gray-800 rounded-xl shadow-2xl max-w-md w-full p-6 animate-slide-up border border-gray-700">
